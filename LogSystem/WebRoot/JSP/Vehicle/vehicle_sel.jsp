...
<body>
		<div class="right" id="mainFrame">
			...
			<div class="right_cont">
				<ul class="breadcrumb">
					当前位置：
					<a href="#">首页</a>
					<span class="divider">/</span> 订单统计管理
				</ul>
				...
				<%-- <div class="title_right">
					<span class="pull-right margin-bottom-5"><a
						...
						href="#modal-container-9735581" role="button" data-toggle="modal"><i
							class="icon-plus icon-white"></i> 显示统计订单</a></span><strong>订单统计管理</strong>
				</div> --%>
				...
				<table class="table table-bordered table-striped table-hover">
					<tbody>
						<tr align="center">
							...
							<td nowrap="nowrap"><strong>订单编号</strong></td>
							<td nowrap="nowrap"><strong>订单名称</strong></td>
							<td nowrap="nowrap"><strong>费用</strong></td>
							<td nowrap="nowrap"><strong>用时</strong></td>
	...
	<div id="modal-container-006" class="modal hide fade"
					...
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true" >×</button>
						<h3 id="myModalLabel">修改订单统计信息</h3>
					</div>
